                    ...
                    <Accordion style={{
                        ...
                        <AccordionDetails style={{ paddingLeft: 0 }}>
                            <div style={{ display: 'flex', justifyContent: 'space-around' }}>
                                <img style={{ width: 20, height: 20 }} src={'/images/linkedin-sign.png'} />
                                <img style={{ width: 20, height: 20 }} src={'/images/social.png'} />
                                <img style={{ width: 20, height: 20 }} src={'/images/facebook.png'} />
                                <img style={{ width: 20, height: 20 }} src={'/images/instagram.png'} />
                                <img style={{ width: 20, height: 20 }} src={'/images/pinterest-logo.png'} />
                            </div>
                        </AccordionDetails>
                    </Accordion>
                </div>
